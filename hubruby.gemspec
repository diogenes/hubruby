...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.rdoc", "Rakefile", "TODO", "lib/github/base.rb", "lib/github/finders.rb", "lib/github/models/repository.rb", "lib/github/models/user.rb", "lib/hubruby.rb", "script/console", "script/destroy", "script/generate"]
